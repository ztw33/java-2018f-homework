...
public class Music
{
    ...
    private static final MediaPlayer[] effectMusic =
            { EFFECT1, EFFECT2, EFFECT3 };
    private static final MediaPlayer[] bgMusic =
            { THEME, BG1, BG2, BG3, BG4, BG5, BG6, BG7, BG8, BG9, BG10, BG11, BG12, BG13, BG14, BG15 };
    public static boolean isBgMusic = true;
    public static boolean isEffectMusic = true;
    public static double BGMVolume = 0.5;
    // private static final MediaPlayer EFFECT4 =
    // MusicManager.getMediaPlayer("../music/open.mp3");
